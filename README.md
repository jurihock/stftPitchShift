...
This repository features two analogical algorithm implementations, [main.cpp](cpp/main.cpp) (C++) and [main.py](python/main.py) (Python). Both contain several [function blocks](#modules) of the same name (but different file extension, of course).
